				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：类型管理 &gt; 类型列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
							...
							<TBODY>
								<TR>
									...
									<FORM id="pageForm" name="managerForm"
										action="${pageContext.request.contextPath }/CategoryAction_list"
										method=post>
										<!-- 隐藏域.当前页码 -->
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="category_name" value="${param.category_name}"></TD>
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#pageBean.list" var="category" >
												<TR 		
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD>
														<s:property value="#category.category_num" />
													</TD>
													<TD>
													<s:property value="#category.category_name" />
													</TD>
													<TD>
													<a href="${pageContext.request.contextPath }/CategoryAction_editUI?category_id=${category.category_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/CategoryAction_delete?category_id=${category.category_id}">删除</a>
													</TD>
												</TR>
												</s:iterator>
