					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0
							...
							<TBODY>
								<TR>
									<TD height=25>
									<FORM id="pageForm" name="managerForm"
										action="${pageContext.request.contextPath }/ManagerAction_list"
										method=post>
										<!-- 隐藏域.当前页码 -->
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="manager_name" value="${param.manager_name}"></TD>
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#pageBean.list" var="manager" >
												<TR 		
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD>
														<s:property value="#manager.manager_num" />
													</TD>
													<TD>
													<s:property value="#manager.manager_name" />
													</TD>
													<TD>
													<s:property value="#manager.enter_time" />
													</TD>
													<TD>
													<s:property value="#manager.email" />
													</TD>
													<TD>
													<s:property value="#manager.sex" />
													</TD>
													<TD>
													<s:property value="#manager.tel" />
													</TD>
													<TD>
													<a href="${pageContext.request.contextPath }/ManagerAction_editUI?manager_id=${manager.manager_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/ManagerAction_delete?manager_id=${manager.manager_id}">删除</a>
													</TD>
												</TR>
												</s:iterator>
