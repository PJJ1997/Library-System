				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：学生管理 &gt; 学生列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0
							...
							<TBODY>
								<TR>
									<TD height=25>
									<FORM id="pageForm" name="studentForm"
										action="${pageContext.request.contextPath }/StudentAction_list"
										method=post>
										<!-- 隐藏域.当前页码 -->
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="stu_name" value="${param.stu_name}"></TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR 		
													...
													<TD>
														<s:property value="#student.stu_num" />
													</TD>
													<TD>
													<s:property value="#student.stu_name" />
													</TD>
													<TD>
													<s:property value="#student.credit_id" />
													</TD>
													<TD>
													<s:property value="#student.academy" />
													</TD>
													<TD>
													<s:property value="#student.profession" />
													</TD>
													<TD>
													<s:property value="#student.class_name" />
													</TD>
													<TD>
													...
													<TD>
													<s:property value="#student.enter_time" />
													</TD>
													<TD>
													<a href="${pageContext.request.contextPath }/StudentAction_editUI?stu_id=${student.stu_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/StudentAction_delete?stu_id=${student.stu_id}">删除</a>
													</TD>
												</TR>
												</s:iterator>
