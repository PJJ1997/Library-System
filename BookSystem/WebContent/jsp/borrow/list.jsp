											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="student.stu_num"></TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR 		
													...
													<TD>
													<a href="${pageContext.request.contextPath }/BorrowAction_editUI?borrow_id=${borrow.borrow_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/BorrowAction_delete?borrow_id=${borrow.borrow_id}">删除</a>
													</TD>
												</TR>
												</s:iterator>
